Взял готовую сборку как временное решение.
буду делать разные прикалюхи, по итогу их должно получиться 50.
# [fifty](https://alexandrkarpovich.github.io/fifty/dist/index.html)
